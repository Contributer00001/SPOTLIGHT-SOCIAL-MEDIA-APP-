            ...
            <KeyboardAvoidingView
                ...
                <View style={styles.commentInput}>
                    ...
                    <TouchableOpacity
                        ...
                        disabled={!newComment.trim()} // Disable button if comment is empty or just spaces
                    >
                        <Text
                            style={[
                                styles.postButton,
                                !newComment.trim() && styles.postButtonDisabled // Apply disabled style when button is disabled
                            ]}
                        >
                            Post
                        </Text>
